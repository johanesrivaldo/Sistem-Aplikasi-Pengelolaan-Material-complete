...
if (isset($_POST['update'])) {
    ...
    $jual = $_POST['jual'];
    $stok = $_POST['stok'];
    $updatestatus = mysqli_query($conn, "update tblbarang set nama='$nama',hrg_beli='$beli',hrg_jual='$jual',stok='$stok' where kode='$kode'");
...
if (isset($_POST['hapus'])) {
    ...
    $updatestatus = mysqli_query($conn, "DELETE FROM tblbarang where kode='$kode'");
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h4 class=" mb-3"><strong>Update Data</strong> Material</h6><br>


                        <?php 
                $id = $_GET['id'];
                $data=mysqli_query($conn, "select * from tblbarang where kode='$id'");
                            ...
                            <div class="card-body">
                                <form method="post">
                                    <div class="col-md-3">
                                        ...
                                        <input type="hidden" name="kode" class="form-control" placeholder="kode"
                                            value="<?php echo $b['kode'] ?>">
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class=" col-md-3">
                                            ...
                                            <input type="text" name="nama" class="form-control"
                                                placeholder="Nama Barang" value="<?php echo $b['nama'] ?>">
                                        </div>
                                        <div class=" col-md-3">
                                            <label for="inputAddress" class="form-label">Harga Beli</label>
                                            <input type="text" name="beli" class="form-control" placeholder="Harga Beli"
                                                value="<?php echo $b['hrg_beli'] ?>">
                                        </div>
                                        <div class=" col-md-3">
                                            <label for="inputAddress" class="form-label">Harga Jual</label>
                                            <input type="text" name="jual" class="form-control" placeholder="Harga Jual"
                                                value="<?php echo $b['hrg_jual'] ?>">
                                        </div>
                                        <div class=" col-md-3">
                                            <label for="inputAddress" class="form-label">Stok</label>
                                            <input type="text" name="stok" class="form-control" placeholder="Stok"
                                                value="<?php echo $b['stok'] ?>">
                                        </div>
