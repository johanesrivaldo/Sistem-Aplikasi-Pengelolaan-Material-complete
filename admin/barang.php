        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h4 class=" mb-3"><strong>Data Material</strong> PT. NIKI FOUR</h6><br>


                        <div class="card "><br>
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="barang_tambah.php" class="btn btn-primary ">Tambah Barang</a><br>
                                <a href="cetak_produk_admin.php" class="btn btn-primary ">Cetak Laporan</a><br>
                            </div>
                            <div class="card-body">
                        ...
                        $h_beli = rupiah($b['hrg_jual']);?>
                                        <tr>
                                            ...
                                            <td><a class="btn btn-primary"
                                                    href="barang_edit.php?id=<?php echo $b['kode'] ?>">Update</a>
