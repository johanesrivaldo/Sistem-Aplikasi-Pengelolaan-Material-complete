...
if (isset($_POST['tambah'])) {
    ...
    $nama = $_POST['nama'];
    $status = $_POST['status'];
    $tambah = mysqli_query($conn, "insert into admin (username, password, nama, status) values ('$username', '$password', '$nama', '$status')");
    ...
    if ($tambah ) {
        ...
        echo "
		 <meta http-equiv='refresh' content='1; url= user_tambah.php'/> ";
    }
};
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <h4 class=" mb-3"><strong>Tambah Data </strong> User</h6><br>
