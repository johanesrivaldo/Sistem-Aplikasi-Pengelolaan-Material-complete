...
if (isset($_POST['tambah'])) {
    ...
    $jual = $_POST['jual'];
    $stok = $_POST['stok'];
    $tambah = mysqli_query($conn, "insert into tblbarang (kode, nama, hrg_beli, hrg_jual, stok) values ('$kode', '$nama', '$beli', '$jual', '$stok')");
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h4 class=" mb-3"><strong>Tambah Data</strong> Material</h6><br>
                        ...
                        <div class="card ">
                            <div class="card-body">
                                <form method="post">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label for="inputAddress" class="form-label">Kode</label>
                                        ...
                                        <div class=" col-md-2">
                                            ...
                                            <input type="text" name="beli" class="form-control"
